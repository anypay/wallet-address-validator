...
describe('WAValidator.validate()', function () {
    describe('valid results', function () {
        ...
        it('should return true for correct raven addresses', function () {

            valid('RS4r9Vzi5G3zWdAUfWLz8abFEWW4f99fmk', 'raven');
            valid('RS4r9Vzi5G3zWdAUfWLz8abFEWW4f99fmk', 'RVN');

	})

        it('should return true for correct smart addresses', function () {

            valid('SgZjH8FGbBtBppMAqkfypx8BcrgebsoYiG21.196', 'smart');
            valid('SPthotFrmCNrXk2hPVgf4rM5UE4UNSnLHH7', 'SMART');

	})
        it.skip('should return true for correct bitcoin addresses', function () {
        ...
        it.skip('should return true for correct bitcoincash addresses', function () {
        ...
        it.skip('should return true for correct litecoin addresses', function () {
        ...
        it.skip('should return true for correct peercoin addresses', function () {
        ...
        it.skip('should return true for correct dogecoin addresses', function () {
        ...
        it.skip('should return true for correct beavercoin addresses', function () {
        ...
        it.skip('should return true for correct freicoin addresses', function () {
        ...
        it.skip('should return true for correct protoshares addresses', function () {
        ...
        it.skip('should return true for correct megacoin addresses', function () {
        ...
        it.skip('should return true for correct primecoin addresses', function () {
        ...
        it.skip('should return true for correct auroracoin addresses', function () {
        ...
        it.skip('should return true for correct namecoin addresses', function () {
        ...
        it.skip('should return true for correct BioCoin addresses', function () {
        ...
        it.skip('should return true for correct Garlicoin addresses', function () {
        ...
        it.skip('should return true for correct Vertcoin addresses', function () {
        ...
        it.skip('should return true for correct BitcoinGold addresses', function () {
        ...
        it.skip('should return true for correct Decred addresses', function () {
        ...
        it.skip('should return true for correct Digibyte addresses', function () {
        ...
        it.skip('should return true for correct Ethereum addresses', function () {
        ...
        it.skip('should return true for correct Ripple addresses', function () {
        ...
        it.skip('should return true for correct dash addresses', function () {
        ...
        it.skip('should return true for correct neo addresses', function () {
            valid('AR4QmqYENiZAD6oXe7ftm6eDcwtHk7rVTT', 'neo');
            valid('AKDVzYGLczmykdtRaejgvWeZrvdkVEvQ1X', 'NEO');
        });

        it.skip('should return true for correct neo gas addresses', function () {
            valid('AR4QmqYENiZAD6oXe7ftm6eDcwtHk7rVTT', 'neogas');
        });

        it.skip('should return true for correct qtum addresses', function () {
        ...
        it.skip('should return true for correct votecoin addresses', function () {
        ...
        it.skip('should return true for correct bitcoinz addresses', function () {
        ...
        it.skip('should return true for correct zclassic addresses', function () {
        ...
        it.skip('should return true for correct hush addresses', function () {
        ...
        it.skip('should return true for correct zcash addresses', function () {
        ...
        it.skip('should return true for correct bitcoinprivate addresses', function () {
            valid('b1M4XXPFhwMb1SP33yhzn3h9qWXjujkgep4', 'bitcoinprivate');
            //valid('bx....', 'BTCP');
            //valid('nx....', 'bitcoinprivate', 'testnet');
        });

        it.skip('should return true for correct snowgem addresses', function () {
        ...
        it.skip('should return true for correct zencash addresses', function () {
        ...
        it.skip('should return true for correct komodo addresses', function () {
        ...
        it.skip('should return true for correct Bankex addresses', function () {
        ...
        it.skip('should return true for correct monero addresses', function () {
        ...
        it.skip('should return true for correct nano addresses', function () {
    ...
    describe('invalid results', function () {
        ...
        it.skip('should return false for incorrect bitcoin addresses', function () {
            commonTests('bitcoin');
        });

        it.skip('should return false for incorrect bitcoincash addresses', function () {
            commonTests('bitcoincash');
        });

        it.skip('should return false for incorrect litecoin addresses', function () {
            commonTests('litecoin');
        });

        it.skip('should return false for incorrect peercoin addresses', function () {
            commonTests('peercoin');
        });

        it.skip('should return false for incorrect dogecoin addresses', function () {
            commonTests('dogecoin');
        });

        it.skip('should return false for incorrect beavercoin addresses', function () {
            commonTests('beavercoin');
        });

        it.skip('should return false for incorrect freicoin addresses', function () {
            commonTests('freicoin');
        });

        it.skip('should return false for incorrect protoshares addresses', function () {
            commonTests('protoshares');
        });

        it.skip('should return false for incorrect megacoin addresses', function () {
            commonTests('megacoin');
        });

        it.skip('should return false for incorrect primecoin addresses', function () {
            commonTests('primecoin');
        });

        it.skip('should return false for incorrect auroracoin addresses', function () {
            commonTests('auroracoin');
        });

        it.skip('should return false for incorrect namecoin addresses', function () {
            commonTests('namecoin');
        });

        it.skip('should return false for incorrect biocoin addresses', function () {
            commonTests('biocoin');
        });

        it.skip('should return false for incorrect garlicoin addresses', function () {
            commonTests('garlicoin');
        });

        it.skip('should return false for incorrect vertcoin addresses', function () {
        ...
        it.skip('should return false for incorrect bitcoingold addresses', function () {
            commonTests('bitcoingold');
        });

        it.skip('should return false for incorrect decred addresses', function () {
            commonTests('decred');
        });

        it.skip('should return false for incorrect bankex addresses', function () {
        ...
        it.skip('should return false for incorrect digibyte addresses', function () {
            commonTests('digibyte');
        });

        it.skip('should return false for incorrect eip55 addresses', function () {
        ...
        it.skip('should return false for incorrect ripple addresses', function () {
        ...
        it.skip('should return false for incorrect dash addresses', function () {
            commonTests('dash');
        });

        it.skip('should return false for incorrect neo addresses', function () {
            commonTests('neo');
            invalid('AR4QmqYENiZAD6oXe7ftm6eDcwtHk7rVTa', 'neo');
            invalid('AKDVzYGLczmykdtRaejgvWeZrvdkVEvQ10', 'NEO');
        });

        it.skip('should return false for incorrect qtum addresses', function () {
            commonTests('qtum');
        ...
        it.skip('should return false for incorrect votecoin addresses', function () {
        ...
        it.skip('should return false for incorrect bitcoinz addresses', function () {
        ...
        it.skip('should return false for incorrect zclassic addresses', function () {
        ...
        it.skip('should return false for incorrect hush addresses', function () {
        ...
        it.skip('should return false for incorrect zcash addresses', function () {
            commonTests('zcash');
        ...
        it.skip('should return false for incorrect bitcoinprivate addresses', function () {
        ...
        it.skip('should return false for incorrect snowgem addresses', function () {
            commonTests('snowgem');
        ...
        it.skip('should return false for incorrect zencash addresses', function () {
            commonTests('zencash');
        ...
        it.skip('should return false for incorrect komodo addresses', function () {
            commonTests('komodo');
        ...
        it.skip('should return false for incorrect monero addresses', function () {
            commonTests('monero');
        ...
        it.skip('should return false for incorrect nano addresses', function () {
            commonTests('nano');
